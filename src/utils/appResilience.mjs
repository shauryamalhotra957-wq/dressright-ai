/**
 * Application Resilience & Synchronization Engine.
 * Features Circuit Breaker, Exponential Jitter Retry, and Offline Fallbacks.
 */

export class AppCircuitOpenError extends Error {
  constructor(message = "Circuit is currently OPEN") {
    super(message);
    this.name = "AppCircuitOpenError";
  }
}
...
export async function resilientAppExecute(fn, {
  fallback = null,
  maxRetries = 3,
  baseDelayMs = 10,
  circuitBreaker = null
